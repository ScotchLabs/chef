...
Vagrant.configure("2") do |config|
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/scotch-labs"
  #   chef.validation_client_name = "scotch-labs-validator"
  #   chef.validation_key_path = ".chef/scotch-labs-validator.pem"
  # end
end
